...
<div id="wrapper">
<h1 style="text-align: center">Our Arithmetic Form</h1>
...
<?php
//  name, phone, lattes, caps, americanos, comments
...
if(isset($_POST['name'],
    ...
    // add my if stat ement regarding fields that are empty
    ...
    if (empty($_POST['name']&&
        ...
        $total = $lattes + $capucinos + $americanos;
                ...
                // i  and elseif statement regarding our time
