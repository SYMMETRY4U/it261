...
// We are going to define a constant to aid in the navigation that will be used in the switch statement
define('THIS_PAGE',basename($_SERVER['PHP_SELF']));
// we are going to be adding an if  statement - if we are on this page it is the index.php page, do something
echo '<ul>';
foreach($nav as $key => $value) {
    if(THIS_PAGE == $key){
